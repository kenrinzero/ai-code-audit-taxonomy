...
**Category `error-handling`.** Same category as [`inconsistent-error-handling`](inconsistent-error-handling.md); the two are sibling patterns within the same error-handling family.
