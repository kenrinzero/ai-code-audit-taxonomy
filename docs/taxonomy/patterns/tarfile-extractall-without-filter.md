...
Three captured specimens from different AI/Python project domains. Specimens live in `evidence/github-issues/`.

- **[mlrun/mlrun](https://github.com/mlrun/mlrun)** — established MLOps platform; `mlrun/package/utils/_archiver.py` extracts archives without member validation. Bandit B202 HIGH. Part of a **2026-03-16 batch audit** filed across 5+ Python repos (mlrun, PyCQA/bandit, alephdata/memorious, eliasgranderubio/dagda, crate/crate-python) with identical structure — suggests an automated security-audit service. References CWE-22. AGENTS.md (6513 bytes). Specimen: [mlrun-mlrun-tarfile.md](../../evidence/github-issues/2026-05-16-mlrun-mlrun-tarfile.md).
- **[kpollz/daily_papers_tool](https://github.com/kpollz/daily_papers_tool)** — arXiv source-archive figure extractor; `summary_utils/extract_figure.py` uses bare extractall on user-supplied archives. Critical severity; self-audit by project author. References Python 3.12 deprecation. AGENTS.md (23367 bytes). Specimen: [kpollz-daily-papers-tool-tarfile.md](../../evidence/github-issues/2026-05-16-kpollz-daily-papers-tool-tarfile.md).
- **[iAmGiG/FFmpeg-AutoToolkit](https://github.com/iAmGiG/FFmpeg-AutoToolkit)** — cross-platform FFmpeg auto-installer; `ffmpeg_manager.py:91-92` extracts internet-downloaded archives. HIGH severity. References **CVE-2007-4559** (the canonical Python tarfile CVE) explicitly. Provides both Python 3.12+ filter recipe and pre-3.12 manual safe_extract recipe — methodologically thorough. Specimen: [iAmGiG-FFmpeg-AutoToolkit-tarfile.md](../../evidence/github-issues/2026-05-16-iAmGiG-FFmpeg-AutoToolkit-tarfile.md).
